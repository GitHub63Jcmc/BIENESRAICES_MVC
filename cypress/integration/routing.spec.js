...
// Prueba la navegación y Router del Header y Footer

describe('Prueba la navegación y Router del Header y Footer', () => {
    ...
    it('Prueba la navegación del Footer', () => {
        ...
        // Revisar que los enlaces footer sean correctos
        ...
        ///cy.get('[data-cy="copyright"]').should('have.prop', 'class').invoke('text').should('equal', 'Joao Cabral de M. C.');
    });
